...
import { getInterestBearingAccounts} from '..//../actions/interestbearingaccounts';
import "./form.css";
    ...
    renderHeader() {
        return (
            <div className="table-head">
                <h1>Manage Interest Bearing Accounts</h1>
        ...
        return (
            <div className="datatable-doc-demo">
                <DataTable ref={(el) => this.dt = el} value={this.props.interestbearingaccounts}
                    ...
                    paginator rows={10} emptyMessage="No Interest-Bearing Accounts found" currentPageReportTemplate="Showing {first} to {last} of {totalRecords} entries"
...
export default connect(mapStateToProps, {getInterestBearingAccounts} ) (InterestBearingAccounts);
