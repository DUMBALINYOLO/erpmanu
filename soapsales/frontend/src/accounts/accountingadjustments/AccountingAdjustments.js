...
import { getAccountingAdjustments} from '..//../actions/accountingadjustments';
import "./form.css";
    ...
    renderHeader() {
        return (
            <div className="table-head">
                <h1>Manage Accounting Adjustments</h1>
        ...
        return (
            <div className="datatable-doc-demo">
                <DataTable ref={(el) => this.dt = el} value={this.props.accountingadjustments}
                    ...
                    paginator rows={10} emptyMessage="No Accounting Adjustments found" currentPageReportTemplate="Showing {first} to {last} of {totalRecords} entries"
...
export default connect(mapStateToProps, {getAccountingAdjustments} ) (AccountingAdjustments);
