...
import { getBillPayments} from '..//../actions/billpayments';
import "./form.css";
    ...
    render() {
        ...
        return (
            <div className="datatable-doc-demo">
                <DataTable ref={(el) => this.dt = el} value={this.props.billpayments}
...
export default connect(mapStateToProps, {getBillPayments} ) (BillPayments);
