...
import { getAccountingPosts} from '..//../actions/accountingposts';
import "./form.css";
...
export default connect(mapStateToProps, {getAccountingPosts} ) (AccountingPosts);
