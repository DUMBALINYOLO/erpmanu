    ...
    render() {
        ...
        return (
            <div className="datatable-doc-demo">
                <DataTable ref={(el) => this.dt = el} value={this.props.payments}
                    ...
                    <Column
                        ...
                        sortable filter filterPlaceholder="Search by Amount Tendered"
                        style={{width:'3em', backgroundColor: '#4EB0A5'}}
                    />
                    <Column
                        className="table-field"
                        ...
                        sortable filter filterPlaceholder="Search by Amount To Pay"
                        style={{width:'3em', backgroundColor: '#4EB0A5'}}
                    />
                    <Column
                        className="table-field"
