      ...
      <div>
        ...
        <PapperBlock title="About Me" icon="ios-contact-outline" whiteBg noMargin desc="Consectetur adipiscing elit. Suspendisse sed urna in justo euismod condimentum.">
          <List dense className={classes.profileList}>
            ...
            <ListItem>
              ...
              <ListItemText primary="Phone" secondary="(+263) 7765432190" />
            </ListItem>
            <ListItem>
              <ListItemAvatar>
                <Avatar>
        ...
        <PapperBlock title="latest Posts" icon="ios-bookmark-outline" whiteBg desc="">
          <div className={classes.albumRoot}>
            <List>
              <ListItem button>
                <ListItemText primary="Curabitur egestas consequat " secondary="Jan 9, 2021" />
              </ListItem>
              <ListItem button>
                <ListItemText primary="Interdum et malesuada fames" secondary="Jan 7, 2021" />
              </ListItem>
              <ListItem button>
                <ListItemText primary="Pellentesque ullamcorper" secondary="July 20, 2021" />
              </ListItem>
              <ListItem button>
                <ListItemText primary="Quisque a consequat ante" secondary="July 20, 2021" />
              </ListItem>
              <ListItem button>
                <ListItemText primary="Donec dignissim odio ac" secondary="July 20, 2021" />
              </ListItem>
              <ListItem button>
                <ListItemText primary="Curabitur egestas consequat " secondary="Jan 9, 2021" />
              </ListItem>
        ...
        {/* ----------------------------------------------------------------------*/}
        {/* Albums Post */}
        <PapperBlock title="Service Posts" icon="ios-images-outline" whiteBg desc="">
          <div className={classes.albumRoot}>
