      ...
      <div className={classNames(classes.contact, !slideMode && classes.withBg)}>
        <div className={classes.container}>
          <div className={classes.contactBubble}>
            <Title title="Say hello to ERPMANU" align="left" nomargin />
            <Typography component="p" className={classes.contactText}>erpmanu@gmail.com<br/> primeleadconsultancy@gmail.com</Typography>
