...
import { getCustomerAddresses} from '..//../actions/customeraddresses';
import "./form.css";
    ...
    renderHeader() {
        return (
            <div className="table-head">
                <h1>Manage Customer Addresses</h1>
        ...
        return (
            <div className="datatable-doc-demo">
                <DataTable ref={(el) => this.dt = el} value={this.props.customeraddresses}
                    ...
                    paginator rows={10} emptyMessage="No Customer Addresses found" currentPageReportTemplate="Showing {first} to {last} of {totalRecords} entries"
...
export default connect(mapStateToProps, {getCustomerAddresses} ) (CustomerAddresses);
