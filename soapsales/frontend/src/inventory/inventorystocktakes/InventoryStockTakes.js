...
import { getInventoryStockTakes} from '..//../actions/inventorystocktakes';
import "./form.css";
    ...
    renderHeader() {
        return (
            <div className="table-head">
                <h1>Manage Inventory Stock Takes</h1>
...
export default connect(mapStateToProps, {getInventoryStockTakes} ) (InventoryStockTakes);
