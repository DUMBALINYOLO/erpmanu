    ...
    renderHeader() {
        return (
            <div className="table-head">
                <h1>Manage Inventory Categories</h1>
        ...
        return (
            <div className="datatable-doc-demo">
                <DataTable ref={(el) => this.dt = el} value={this.props.inventorycategories}
                    ...
                    paginator rows={10} emptyMessage="No Inventory Categories found" currentPageReportTemplate="Showing {first} to {last} of {totalRecords} entries"
                    ...
                    <Column
                        ...
                        field="parent"
                        header="Parent"
                        sortable filter filterPlaceholder="Search by Parent"
                        style={{width:'3em', backgroundColor: '#4EB0A5'}}
                    />
                    <Column
                        className="table-field"
                        field="children"
                        header="Children"
                        sortable filter filterPlaceholder="Search by Children"
                        style={{width:'3em', backgroundColor: '#4EB0A5'}}
                    />
                    <Column
                        className="table-field"
...
export default connect(mapStateToProps, {getInventoryCategories} ) (InventoryCategories);
