...
import { getInventoryOrderpayments} from '..//../actions/inventoryorderpayments';
import "./form.css";
    ...
    renderHeader() {
        return (
            <div className="table-head">
                <h1>Manage Inventory Orderpayments</h1>
...
export default connect(mapStateToProps, {getInventoryOrderpayments} ) (InventoryOrderpayments);
