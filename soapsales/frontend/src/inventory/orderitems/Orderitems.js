    ...
    render() {
        ...
        return (
            <div className="datatable-doc-demo">
                <DataTable ref={(el) => this.dt = el} value={this.props.orderitems}
                    ...
                    paginator rows={10} emptyMessage="No Order Items found" currentPageReportTemplate="Showing {first} to {last} of {totalRecords} entries"
...
export default connect(mapStateToProps, {getOrderItems} ) (OrderItems);
