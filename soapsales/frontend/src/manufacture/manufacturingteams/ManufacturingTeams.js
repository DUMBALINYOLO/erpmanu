    ...
    renderHeader() {
        return (
            <div className="table-head">
                <h1>List of Manufacturing Teams</h1>
        ...
        return (
            <div className="datatable-doc-demo">
                <DataTable ref={(el) => this.dt = el} value={this.props.manufacturingteams}
                    ...
                    paginator rows={10} emptyMessage="No ManufacturingTeams found" currentPageReportTemplate="Showing {first} to {last} of {totalRecords} entries"
...
export default connect(mapStateToProps, {getManufacturingTeams} ) (ManufacturingTeams);
