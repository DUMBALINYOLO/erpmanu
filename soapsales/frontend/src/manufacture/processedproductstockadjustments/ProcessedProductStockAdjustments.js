...
import { getProcessedProductStockAdjustments} from '..//../actions/processedproductstockadjustments';
import "./form.css";
...
class ProcessedProductStockAdjustments extends Component {
    ...
    constructor() {
        super();
        this.state = {
            processedproductstockadjustments : null,
            globalFilter: null,
            dateFilter: null,
    ...
    renderHeader() {
        return (
            <div className="table-head">
                <h1>List of Processed Product Stock Adjustments</h1>
        ...
        return (
            <div className="datatable-doc-demo">
                <DataTable ref={(el) => this.dt = el} value={this.props.processedproductstockadjustments}
                    ...
                    paginator rows={10} emptyMessage="No ProcessedProductStockAdjustments found" currentPageReportTemplate="Showing {first} to {last} of {totalRecords} entries"
...
export default connect(mapStateToProps, {getProcessedProductStockAdjustments} ) (ProcessedProductStockAdjustments);
