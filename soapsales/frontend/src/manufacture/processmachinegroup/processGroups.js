    ...
    renderHeader() {
        return (
            <div className="table-head">
                <h1>List Of Process Machine Groups</h1>
    ...
    render() {
        ...
        return (
            <div className="datatable-doc-demo">
                <DataTable ref={(el) => this.dt = el} value={this.props.processgroups}
...
export default connect(mapStateToProps, {getProcessGroups} ) (ProcessGroups);
