...
import { getWasteGenerationReports} from '..//../actions/wastegenerationreports';
...
export default connect(mapStateToProps, {getWasteGenerationReports} ) (WasteGenerationReports);
