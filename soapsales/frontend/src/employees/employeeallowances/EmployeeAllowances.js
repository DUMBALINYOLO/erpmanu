        ...
        return (
            <div className="datatable-doc-demo">
                <DataTable ref={(el) => this.dt = el} value={this.props.employeeallowances}
                    ...
                    selection={this.state.selectedEmployeeAllowances} onSelectionChange={e => this.setState({selectedEmployeeAllowances: e.value})}
                    paginator rows={10} emptyMessage="No EmployeeAllowances found" currentPageReportTemplate="Showing {first} to {last} of {totalRecords} entries"
                    ...
                    <Column
                        ...
                        header="Taxable"
                        sortable filter
                        filterPlaceholder="Search by Taxable"
                        style={{width:'3em'}}
                        headerStyle={{width: '3em', backgroundColor: '#4EB0A5', textAlign: 'center'}}
                    />
                    <Column
...
export default connect(mapStateToProps, {getEmployeeAllowances} ) (EmployeeAllowances);
