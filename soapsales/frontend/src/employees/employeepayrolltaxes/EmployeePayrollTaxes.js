        ...
        return (
            <div className="datatable-doc-demo">
                <DataTable ref={(el) => this.dt = el} value={this.props.employeepayrolltaxes}
                    ...
                    paginator rows={10} emptyMessage="No EmployeePayrollTaxes found" currentPageReportTemplate="Showing {first} to {last} of {totalRecords} entries"
                    ...
                    <Column
                        ...
                        header="Paid By"
                        sortable filter
                        filterPlaceholder="Search by Paid By"
                        style={{width:'3em'}}
                        headerStyle={{width: '3em', backgroundColor: '#4EB0A5', textAlign: 'center'}}
                    />
                    <Column
...
export default connect(mapStateToProps, {getEmployeePayrollTaxes} ) (EmployeePayrollTaxes);
