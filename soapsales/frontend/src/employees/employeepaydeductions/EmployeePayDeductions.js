    ...
    renderHeader() {
        return (
            <div className="table-head">
                <h1>Manage Employee Pay Deductions</h1>
        ...
        return (
            <div className="datatable-doc-demo">
                <DataTable ref={(el) => this.dt = el} value={this.props.employeepaydeductions}
                    ...
                    paginator rows={10} emptyMessage="No EmployeePayDeductions found" currentPageReportTemplate="Showing {first} to {last} of {totalRecords} entries"
...
export default connect(mapStateToProps, {getEmployeePayDeductions} ) (EmployeePayDeductions);
