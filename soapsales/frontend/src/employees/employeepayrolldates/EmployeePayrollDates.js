...
import { getEmployeePayrollDates} from '..//../actions/employeepayrolldates';
import "./form.css";
    ...
    renderHeader() {
        return (
            <div className="table-head">
                <h1>Manage Employee Payroll Dates</h1>
        ...
        return (
            <div className="datatable-doc-demo">
                <DataTable ref={(el) => this.dt = el} value={this.props.employeepayrolldates}
                    ...
                    paginator rows={10} emptyMessage="No EmployeePayrollDates found" currentPageReportTemplate="Showing {first} to {last} of {totalRecords} entries"
...
export default connect(mapStateToProps, {getEmployeePayrollDates} ) (EmployeePayrollDates);
