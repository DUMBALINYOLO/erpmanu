...
class CompanyInventoryControllerForm extends Component{
    constructor(props){
        super(props);
        this.state = {
            email: '',
    ...
    onSubmit = (e) => {
        ...
        const companyinventorycontroller = {
            email,
			category,
			phone,
			first_name,
        ...
        this.props.addCompanyInventoryController(companyinventorycontroller);
        this.setState({
            email: '',
			category: '',
			phone: '',
        ...
        this.props.history.push('/companyinventorycontrollers');
    };
    ...
    render() {
        ...
        return (
            <div className="card card-body mt-4 mb-4">
              <h2>Manage Company Inventory Controller</h2>
