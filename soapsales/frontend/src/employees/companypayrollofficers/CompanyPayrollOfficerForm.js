...
import { addCompanyPayrollOfficer } from '..//../actions/companypayrollofficers';
...
class CompanyPayrollOfficerForm extends Component{
    constructor(props){
        super(props);
        this.state = {
            email: '',
    ...
    onSubmit = (e) => {
        ...
        this.props.addCompanyPayrollOfficer(companypayrollofficer);
        this.setState({
            email: '',
			category: '',
			phone: '',
        ...
        this.props.history.push('/companypayrollofficers');
    };

    static propTypes = {
        addCompanyPayrollOfficer: PropTypes.func.isRequired,
    ...
    render() {
        ...
        return (
            <div className="card card-body mt-4 mb-4">
              <h2>Manage CompanyPayrollOfficer</h2>
...
export default connect(mapStateToProps, {getEmployeesTypeChoices, getEmployeesGenderChoices, getEmployeePaygrades, addCompanyPayrollOfficer})(CompanyPayrollOfficerForm);
