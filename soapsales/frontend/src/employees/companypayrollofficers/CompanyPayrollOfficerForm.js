...
export default connect(mapStateToProps, {getEmployeesTypeChoices, getEmployeesGenderChoices, getPayGrades, addCompanyPayrollOfficer})(CompanyPayrollOfficerForm);
