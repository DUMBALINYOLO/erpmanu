...
import { addCompanyManufacturingPersonell } from '..//../actions/companymanufacturingpersonells';
...
class CompanyManufacturingPersonellForm extends Component{
    constructor(props){
        super(props);
        this.state = {
            email: '',
    ...
    onSubmit = (e) => {
        ...
        const companymanufacturingpersonell = {
            email,
			category,
			phone,
			first_name,
        ...
        this.props.addCompanyManufacturingPersonell(companymanufacturingpersonell);
        this.setState({
            email: '',
			category: '',
			phone: '',
        ...
        this.props.history.push('/companymanufacturingpersonells');
    };

    static propTypes = {
        addCompanyManufacturingPersonell: PropTypes.func.isRequired,
    ...
    render() {
        ...
        return (
            <div className="card card-body mt-4 mb-4">
              <h2>Manage Company Manufacturing Personell</h2>
...
export default connect(mapStateToProps, {getEmployeesTypeChoices, getEmployeesGenderChoices, getEmployeePaygrades, addCompanyManufacturingPersonell})(CompanyManufacturingPersonellForm);
