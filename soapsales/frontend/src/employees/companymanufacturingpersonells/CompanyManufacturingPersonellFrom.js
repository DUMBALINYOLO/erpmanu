...
export default connect(mapStateToProps, {getEmployeesTypeChoices, getEmployeesGenderChoices, getPayGrades, addCompanyManufacturingPersonell})(CompanyManufacturingPersonellForm);
