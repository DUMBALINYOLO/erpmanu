...
import { addCompanyDriver } from '..//../actions/companydrivers';
...
class CompanyDriverForm extends Component{
    constructor(props){
        super(props);
        this.state = {
            email: '',
    ...
    onSubmit = (e) => {
        ...
        this.props.addCompanyDriver(companydriver);
        this.setState({
            email: '',
			category: '',
			phone: '',
        ...
        this.props.history.push('/companydrivers');
    };

    static propTypes = {
        addCompanyDriver: PropTypes.func.isRequired,
...
export default connect(mapStateToProps, {getEmployeesTypeChoices, getEmployeesGenderChoices, getEmployeePaygrades, addCompanyDriver})(CompanyDriverForm);
