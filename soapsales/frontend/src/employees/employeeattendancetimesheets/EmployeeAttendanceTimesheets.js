...
import { getEmployeeAttendanceTimesheets} from '..//../actions/employeeattendancetimesheets';
import "./form.css";
...
class EmployeeAttendanceTimesheets extends Component {
    ...
    constructor() {
        super();
        this.state = {
            employeeattendancetimesheets: null,
            globalFilter: null,
            dateFilter: null,
    ...
    renderHeader() {
        return (
            <div className="table-head">
                <h1>Manage Employee Attendance Timesheets</h1>
        ...
        return (
            <div className="datatable-doc-demo">
                <DataTable ref={(el) => this.dt = el} value={this.props.employeeattendancetimesheets}
                    ...
                    paginator rows={10} emptyMessage="No EmployeeAttendanceTimesheets found" currentPageReportTemplate="Showing {first} to {last} of {totalRecords} entries"
...
export default connect(mapStateToProps, {getEmployeeAttendanceTimesheets} ) (EmployeeAttendanceTimesheets);
