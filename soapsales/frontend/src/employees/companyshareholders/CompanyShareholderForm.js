...
import { addCompanyShareholder } from '..//../actions/companyshareholders';
...
class CompanyShareholderForm extends Component{
    constructor(props){
        super(props);
        this.state = {
            email: '',
    ...
    onSubmit = (e) => {
        ...
        this.props.addCompanyShareholder(companyshareholder);
        this.setState({
            email: '',
			category: '',
			phone: '',
        ...
        this.props.history.push('/companyshareholders');
    };

    static propTypes = {
        addCompanyShareholder: PropTypes.func.isRequired,
    ...
    render() {
        ...
        return (
            <div className="card card-body mt-4 mb-4">
              <h2>Manage Company Shareholder</h2>
...
export default connect(mapStateToProps, {getEmployeesTypeChoices, getEmployeesGenderChoices, getEmployeePaygrades, addCompanyShareholder})(CompanyShareholderForm);
