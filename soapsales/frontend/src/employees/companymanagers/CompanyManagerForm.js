...
import { addCompanyManager } from '..//../actions/companymanagers';
...
class CompanyManagerForm extends Component{
    constructor(props){
        super(props);
        this.state = {
            email: '',
    ...
    onSubmit = (e) => {
        ...
        this.props.history.push('/companymanagers');
    };
...
export default connect(mapStateToProps, {getEmployeesTypeChoices, getEmployeesGenderChoices, getEmployeePaygrades, addCompanyManager})(CompanyManagerForm);
