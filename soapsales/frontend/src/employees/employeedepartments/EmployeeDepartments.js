    ...
    renderHeader() {
        return (
            <div className="table-head">
                <h1>Manage Employee Departments</h1>
        ...
        return (
            <div className="datatable-doc-demo">
                <DataTable ref={(el) => this.dt = el} value={this.props.employeedepartments}
                    ...
                    paginator rows={10} emptyMessage="No EmployeeDepartments found" currentPageReportTemplate="Showing {first} to {last} of {totalRecords} entries"
...
export default connect(mapStateToProps, {getEmployeeDepartments} ) (EmployeeDepartments);
