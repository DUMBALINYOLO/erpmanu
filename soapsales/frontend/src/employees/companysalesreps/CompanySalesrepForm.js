...
import { addCompanySalesrep } from '..//../actions/companysalesreps';
...
class CompanySalesrepForm extends Component{
    constructor(props){
        super(props);
        this.state = {
            email: '',
    ...
    onSubmit = (e) => {
        ...
        this.props.addCompanySalesrep(companysalesrep);
        this.setState({
            email: '',
			category: '',
			phone: '',
        ...
        this.props.history.push('/companysalesreps');
    };

    static propTypes = {
        addCompanySalesrep: PropTypes.func.isRequired,
...
export default connect(mapStateToProps, {getEmployeesTypeChoices, getEmployeesGenderChoices, getEmployeePaygrades, addCompanySalesrep})(CompanySalesrepForm);
