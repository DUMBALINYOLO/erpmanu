    ...
    renderHeader() {
        return (
            <div className="table-head">
                <h1>Manage Employee Paygrades</h1>
        ...
        return (
            <div className="datatable-doc-demo">
                <DataTable ref={(el) => this.dt = el} value={this.props.employeepaygrades}
                    ...
                    paginator rows={10} emptyMessage="No EmployeePaygrades found" currentPageReportTemplate="Showing {first} to {last} of {totalRecords} entries"
...
export default connect(mapStateToProps, {getEmployeePaygrades} ) (EmployeePaygrades);
